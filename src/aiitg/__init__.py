...
from aiitg.core.detector import Detector, DetectorRegistry, run_scan
...
from aiitg.core.registry import FormatRegistry
from aiitg.pipeline import PipelineResult, process_file
